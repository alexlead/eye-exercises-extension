...
declare global {
  ...
  const EXERCISES: typeof import('D:/chrome-extentions/eyes-excersizes-tool/eye-exercises/utils/exercises').EXERCISES
  const InvalidMatchPattern: typeof import('wxt/utils/match-patterns').InvalidMatchPattern
  const MatchPattern: typeof import('wxt/utils/match-patterns').MatchPattern
  const browser: typeof import('wxt/browser').browser
  const cn: typeof import('D:/chrome-extentions/eyes-excersizes-tool/eye-exercises/utils/cn').cn
  const createIframeUi: typeof import('wxt/utils/content-script-ui/iframe').createIframeUi
  const createIntegratedUi: typeof import('wxt/utils/content-script-ui/integrated').createIntegratedUi
  const createShadowRootUi: typeof import('wxt/utils/content-script-ui/shadow-root').createShadowRootUi
  const defaultSettings: typeof import('D:/chrome-extentions/eyes-excersizes-tool/eye-exercises/utils/storage').defaultSettings
  ...
  const loadSettings: typeof import('D:/chrome-extentions/eyes-excersizes-tool/eye-exercises/utils/storage').loadSettings
  const saveSettings: typeof import('D:/chrome-extentions/eyes-excersizes-tool/eye-exercises/utils/storage').saveSettings
...
declare global {
  ...
  // @ts-ignore
  export type { TrajectoryType, Exercise } from 'D:/chrome-extentions/eyes-excersizes-tool/eye-exercises/utils/exercises'
  import('D:/chrome-extentions/eyes-excersizes-tool/eye-exercises/utils/exercises')
  // @ts-ignore
  export type { AppSettings } from 'D:/chrome-extentions/eyes-excersizes-tool/eye-exercises/utils/storage'
  import('D:/chrome-extentions/eyes-excersizes-tool/eye-exercises/utils/storage')
}
