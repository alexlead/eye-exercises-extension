		...
		browser.alarms.onAlarm.addListener(async (alarm) => {
			if (alarm.name === "eye_exercise_reminder") {
				...
				if (usePush) browser.notifications.create({
					type: "basic",
					iconUrl: browser.runtime.getURL("/icon-alert.png"),
